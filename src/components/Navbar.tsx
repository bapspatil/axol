...
export default function Navbar() {
    ...
    return (
        <header className="fixed z-20 mt-8 md:mt-12 w-full md:w-auto inline-flex flex-col items-center justify-start">
            <a className="hidden md:inline-flex w-fit h-auto px-6 py-1 bg-axol-coral border-x-2 border-t-2 border-transparent hover:border-node-indigo transition-all duration-300 rounded-tl-full rounded-tr-full justify-center items-center gap-2  group" href="#">
            ...
            <Dialog as="div" className="md:hidden" open={$isMenuOpen} onClose={() => isMenuOpen.set(!$isMenuOpen)}>
                <Dialog.Panel className="fixed inset-y-0 right-0 z-30 w-full overflow-y-auto px-4 py-[34px] flex flex-col items-end justify-start gap-4">
